...
public class query_search {
	...
	public void queryMaker(HashMap<String,String> user_index,List<String> list_of_stopwords) throws IOException, ParseException{

		List<String> stopwords_removed = new ArrayList<String>();

		for(Entry<String, String> entry: user_index.entrySet()){
			...
			FSDirectory directory = NIOFSDirectory.open(new File("/Users/akmaralakhanova/Documents/ucd_my_workspace/"
					+ "review-based-recommendation/Resource/productIndexOut"));
			...
			if(!recommendations.containsValue(productID)){
				recommendations.put(key, productID);
			}
			reader.close();
			directory.close();
